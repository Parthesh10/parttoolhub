...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: 'Convert bytes, KB, MB, GB, TB and PB — decimal (1000-based) and binary (1024-based) shown separately, the exact reason a 1 TB drive shows as 931 GB.',
    short: 'Convert between bytes, KB, MB, GB, TB and PB — decimal and binary shown separately, not conflated.',
    category: 'converters',
