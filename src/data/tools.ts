...
export const TOOLS: Tool[] = [
  // ---- Converters & Formatters --------------------------------------------
  {
    ...
    description: 'Turn a column of values into a comma separated list instantly. Custom separators, quotes, dedupe and sort, all in your browser with nothing uploaded.',
  ...
  },
  {
    ...
    title: 'Data Size Converter: Bytes to KB, MB, GB, TB',
    description: 'Convert bytes, KB, MB, GB, TB and PB. Decimal and binary are shown separately, the exact reason a 1 TB drive shows as 931 GB.',
    short: 'Convert between bytes, KB, MB, GB, TB and PB, with decimal and binary shown separately instead of conflated.',
    category: 'converters',
  ...
  },
  {
    ...
    category: 'converters',
    features: ['Headings, emphasis, code, links, images, nested lists, tables, quotes, rules', 'Tolerant of unclosed tags, stray closers and inline styles', 'Scripts, styles and comments removed', 'Markdown-significant characters escaped so the text reads as written', 'Runs entirely client-side, so nothing you paste is uploaded'],
  ...
  },
  {
    ...
    category: 'text-tools',
    features: ['Keeps bullets, numbering, nesting, quotes and tables as readable text', 'Links as "text (url)", the URL only, or the text only', 'Slack, WhatsApp and Google Chat markup modes', 'Tables aligned in columns', 'The conversion happens in your browser, so nothing is uploaded'],
  ...
  },
  {
    ...
    short: 'Paste Markdown and download an actual .docx file: headings, lists, tables and links are all real Word elements, not a pasted approximation.',
    category: 'text-tools',
    features: ['Downloads a real .docx (OOXML), not a copy-paste approximation', 'Headings, bold, italic, strikethrough, links, lists, tables, quotes and code blocks', 'Nested bullet and numbered lists, each numbered list restarting correctly', 'Live preview before you download', 'Built by hand in the browser, with no upload, no server and no third-party library'],
  ...
  },
  {
    ...
    category: 'text-tools',
    features: ['Reads the formatting of a paste, not just its text', 'Docs quirks handled: styled spans, redirect links, nested lists', 'Headings, bold, italic, strikethrough, code, links, lists, tables', 'Notes tell you what was unwrapped, dropped or approximated', 'Processed locally in the browser, never uploaded'],
  ...
  },
  {
    ...
    description: 'Encode text to Base64 or decode Base64 back to text, with full Unicode support and URL-safe mode. Instant and private, and nothing is uploaded.',
  ...
  },
  {
    ...
    category: 'encoders',
    features: ['Drag and drop, file picker, or paste from the clipboard', 'Raw Base64, data URI, <img> tag and CSS url() outputs', 'MIME type taken from the file bytes, not the file name', 'Shows the size before and after encoding', 'The image never leaves your device during encoding'],
