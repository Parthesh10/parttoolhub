...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    slug: 'generators',
    name: 'Generators',
    description: 'Generate UUIDs, strong passwords and Lorem Ipsum placeholder text on demand, right in your browser — nothing sent anywhere.',
